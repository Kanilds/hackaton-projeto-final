...
public class PessoaServicoTeste {
    ...
    public void testeValidarPessoa() {
        ...
        Boolean retornoVP = pessoaServico.validaSeExisteEmailCadastrado(pessoa);
    ...
    public void testeObterPessoaComRelacionamentos() {
        ...
        Optional<List<Pessoa>> obterRetornoPessoaComRelacionamentos = pessoaServico.obterPessoaCheia();
